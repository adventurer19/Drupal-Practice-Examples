        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    '/home/nikolay/drupal-projects/first-project/Fresh-Install-Drupal-Setup/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl',
                );
            } else {
                $template = new Template(
                    '/home/nikolay/drupal-projects/first-project/Fresh-Install-Drupal-Setup/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl',
                );
            }
